"""
증거 원장 FastAPI 앱 — DB 초기화 포함
"""
from fastapi import FastAPI
from pcag.apps.evidence_ledger.routes import router
...
# Setup logging
setup_logging("evidence-ledger")

app = FastAPI(title="PCAG Evidence Ledger", version="0.1.0")
